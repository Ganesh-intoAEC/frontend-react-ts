...
import CustomTabCard from "../../../../components/tabNavigation/customTabCard";
import LeadProfileCard from "./_leadProfileCard";
import comingSoonBg from "../../../../../assets/images/Coming soon page img.svg";
import ArrowBackIosNewIcon from "@mui/icons-material/ArrowBackIosNew";
import IconButton from "@mui/material/IconButton";
import { useNavigate } from "react-router-dom";
import WonIcon from "../../../../../assets/icons/won-icon";
import { Button, Card, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormHelperText, TextField, Tooltip } from "@mui/material";
      ...
      <div className="container ">
        <div className="row">
          <div className="col-lg-3 col-md-12">
            <LeadProfileCard LeadCurrentStatus={leadCurrentStatus} leadSelectedStatus={leadSelectedStatus} data={initialData} />
          </div>
 ...
 <div>
        ...
        >
          <DialogTitle id="alert-dialog-title" className="d-inline-block">
              {(leadStatus === "Won" || leadStatus == "Lost")  && (
                ...
                <span>{`Lead Status as ${leadStatus} (`} </span>
                    ...
                    <Tooltip
                      ...
                      key={leadStatus}
                    >
                      {leadStatus === "Won" ? <WonIcon style={{ width: "30px", height: "30px", fill: "#2ED47A" ,transform: 'scale(1.5)',margin:' -4px 1px -8px -4px'}} /> : <LostIcon style={{ width: "30px", height: "30px", fill: "#F7685B" ,transform: 'scale(1.5)',margin:' -4px 1px -8px -4px'}}  />}
                    </Tooltip></span>
              ...
              <Divider />
              {!(leadStatus === "Won" || leadStatus == "Lost")  &&(<DialogContent>
                {leadStatus === "Snooze" && (<LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    className="my-2"
                    slotProps={{
                      textField: {
