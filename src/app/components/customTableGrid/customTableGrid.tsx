              ...
              {sortedRows
                ...
                .map((row) => (
                  ...
                  >
                    <TableCell padding="checkbox">
                      <Checkbox
                        checked={selectedRows.includes(row.leadName)}
                        onChange={() => handleRowSelection(row.leadName)}
                      />
                    </TableCell>
                    ...
                    <TableCell align="center">{row.leadCreated}</TableCell>
                    <TableCell align="center">{row.estimation}</TableCell>
