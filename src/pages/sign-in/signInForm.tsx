            ...
            <Box className="w-100 px-2">
              ...
              <Box className=" px-4 d-flex justify-content-between">
                ...
                <FormControlLabel
                  ...
                  label="Remember me"
                />
                <Link style={{fontSize:'10px', textDecoration:'none'}} href="/sign-in/forget-password" passHref >
                  {"Forgot Password?"}
                </Link>
              </Box>
              <Box className="my-5">
              ...
              <Box className="my-3 mb-5 pb-3">
                <span>
                  ...
                  <Link style={{textDecoration:'none', fontWeight:'600', color:'#109CF1'}} href="/sign-up"  >
                    {"Sign Up"}
                  </Link>
                </span>
              </Box>
